/*
Reto #15: La escalera
https://github.com/hdescobarh/retos-programacion-2023/blob/main/Retos/Reto%20%2316%20-%20LA%20ESCALERA%20%5BMedia%5D/ejercicio.md
...
impl Staircase {
    ...
    pub fn draw_stair(&self) -> String {
        ...
        let mut line_list: Vec<String> = Vec::with_capacity(self.step_number);
